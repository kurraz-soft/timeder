    ...
    export default {
        ...
        methods: {
            handleChange(){
                ...
                if(this.__value)
                    this.$router.push({name: 'project', params: { project_id:  this.__value, filter_status: this.$store.getters.defaultFilterStatusId, date: this.$store.getters.getCurrentMonth}});
                else
                    this.$router.push('/');
